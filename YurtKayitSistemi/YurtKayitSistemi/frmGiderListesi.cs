...
namespace YurtKayitSistemi
{
    public partial class frmGiderListesi : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtKayitDataSet4.Odemeler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.odemelerTableAdapter.Fill(this.yurtKayitDataSet4.Odemeler);
